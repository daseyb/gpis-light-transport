...
GPPathTracer::GPPathTracer(TraceableScene *scene, const GPPathTracerSettings &settings, uint32 threadId)
...
Vec3f GPPathTracer::traceSample(Vec2u pixel, PathSampleGenerator &sampler)
{
