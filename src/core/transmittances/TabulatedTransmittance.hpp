#ifndef TABULATEDTRANSMITTANCE_HPP_
#define TABULATEDTRANSMITTANCE_HPP_
...
class TabulatedTransmittance : public Transmittance
{
...
#endif /* TABULATEDTRANSMITTANCE_HPP_ */
